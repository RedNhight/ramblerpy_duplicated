...
def register_yandex_account(proxy, receiver, twocaptcha_token):
    ...
    y.driver_close()
    return [error_step, rf[0]+'@yandex.ru', rf[1], ptp[0]]
...
if __name__ == '__main__':
    while True:
        ...
        while True:
            ...
            sleep(5)
        if len(list_of_ip) > 1:
            # fake_auth_rambler(random.choice(list_of_ip), 'mail', 'passwd')
            # fake_auth_yandex(random.choice(list_of_ip), 'kopylovnikitanikita@yandex.ru', 'MnS90099')
